...
def get_config_location(file='C:/Users/MARIOPEREZBENAVIDES/jsnapy/testcase_python/venv/jsnapy.cfg'):
    p_locations = []
...
def get_path(section, value):
    ...
    if custom_dir:
        ...
        config_location = os.path.join(config_location, 'C:/Users/MARIOPEREZBENAVIDES/jsnapy/testcase_python/venv/jsnapy.cfg')
